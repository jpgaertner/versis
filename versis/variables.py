...
VARIABLES = dict(
    ...
    zeta            = Variable("Bulk ice viscosity", grid, "Ns/m2"),
    eta             = Variable("Shear ice viscosity", grid, "Ns/m2"),
    ...
    sigma11         = Variable("Stress tensor element", grid, "N/m2"),
    sigma22         = Variable("Stress tensor element", grid, "N/m2"),
    sigma12         = Variable("Stress tensor element", grid, "N/m2"),
    ...
    tauX            = Variable("Zonal surface stress", grid, "N/m2"),
    tauY            = Variable("Meridional surface stress", grid, "N/m2"),
    ...
    fu              = Variable("Zonal stress on ocean surface", grid, "N/m2"),
    fv              = Variable("Meridional stress on ocean surface", grid, "N/m2"),
    ...
    precip          = Variable("Precipitation rate (freshwater flux, decreases salinity)", grid, "m/s"),
    ...
    rA              = Variable("Grid cell area centered around c-point", grid, "2"),
    rAu             = Variable("Grid cell area centered around u-point", grid, "2"),
    rAv             = Variable("Grid cell area centered around v-point", grid, "2"),
    rAz             = Variable("Grid cell area centered around z-point", grid, "2"),
    ...
    # for debugging #TODO remove this after debugging
    F_lh            = Variable("Latent heat flux at the ice surface (sublimation)", grid, "W/m2"),
    F_lwu           = Variable("Longwave ice surface heat flux", grid, "W/m2"),
    F_sens          = Variable("Sensible ice surface heat flux", grid, "W/m2"),
    q_s             = Variable("Specific humidity of the air at the ice surface", grid, "kg/kg"),
    F_ia_net        = Variable("Net heat flux divergence at the ice surface", grid, "W/m2"),
    F_io_net        = Variable("Net upward conductive flux through the ice", grid, "W/m2"),
    F_oi            = Variable("Heat flux from the ocean to the ice", grid, "W/m2"),
    ...
    surf_theta = Variable("",grid,""),
    TempFrz=Variable("",grid,"")
)