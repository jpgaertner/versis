...
SETTINGS = dict(
    ...
    growthTesting       = Setting(False, bool, "flag for comparing the thermodynamics with the MITgcm"),
    ...
    rhoSea              = Setting(1026, float, "reference density of sea water (Boussinesq approximation) [kg/m3]"),
