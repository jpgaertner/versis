...
SETTINGS = dict(
    ...
    growthTesting       = Setting(True, bool, "flag for comparing the thermodynamics with the MITgcm"),
    printSolve4TempVars = Setting(False, bool, "flag for printing the solve4temp inputs and outputs"),
    rhoIce              = Setting(910, float, "density of ice [kg/m3]"), # dynamics: 900
    rhoFresh            = Setting(999.8, float, "density of fresh water [kg/m3]"), # 1000
    rhoSea              = Setting(1027, float, "reference density of sea water (Boussinesq approximation) [kg/m3]"), # 1026
    rhoAir              = Setting(1.2, float, "density of air [kg/m3]"), # 1.3
